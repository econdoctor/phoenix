...
exit();}
$sql = "SELECT user_type, user_avatar, user_teacher, user_alias, user_title, user_first_name, user_last_name, user_name, user_code FROM phoenix_users WHERE user_id ='".$user_id."'";
...
if($user_type == 1 && $user_alias == ''){
header("Location: ../alias_change.php?m=1");
exit();}
if($user_type == 1 && $user_avatar == 0){
header("Location: ../avatar_change.php?m=1");
exit();}
...
if($user_type == 1 && $user_avatar != 0){
?>
<p><img src="./avatars/Character%20<?php echo $user_avatar; ?>.png" width="200"><br>
<b style="font-size: larger;"><?php echo $user_alias; ?></b></p>
<?php
}
if($user_type == 1 && $user_teacher == 0){
?>
<br>
<p><b>Your ID code:</b><br><b style="color: #033909; font-size: larger;"><?php echo $user_code; ?></b></p>
<p><b style="color: #820000">Your teacher should use this code to manage your account.</b></p>
<?php
}
if($user_type == 2){
?>
<br>
<p><b>Your ID code:</b><br><b style="color: #033909; font-size: larger;"><?php echo $user_code; ?></b></p>
<p><b style="color: #820000">Your students should use this code when creating their account.</b></p>
<?php
}
?>
</body>
