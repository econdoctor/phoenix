...
<p style="font-size: x-large"><b>MANAGE</b></p><p>
<input type="button" name="live" value="LIVE" onclick="document.location.href='live.php';"/>&nbsp;&nbsp;
<input type="button" id="students" name="details" value="STUDENTS" onclick="document.location.href='manage_students.php';"/>&nbsp;&nbsp;
<input type="button" name="groups" value="GROUPS" onclick="document.location.href='manage_groups.php';"/>&nbsp;&nbsp;
<input type="button" name="permissions" value="PERMISSIONS" onclick="document.location.href='manage_permissions.php';"/>&nbsp;&nbsp;
<input type="button" name="thresholds" value="THRESHOLDS" onclick="document.location.href='manage_thresholds.php';"/>
</p></body></html>