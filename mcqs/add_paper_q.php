...
header("Location: add_paper_ms.php?paper_reference=$paper_reference&e=1");
exit();}}
$link = $paper_syllabus. '/' . $paper_reference . '.pdf';
?>
<!doctype html>
<html>
<head>
...
<p><input type="button" value="DOWNLOAD QUESTION PAPER" onclick="window.open('./qp/<?php echo $link; ?>', '_blank');"></p>
<p><b style="color: #820000;"><u>INSTRUCTIONS</u>:<br><br>
- Click on the link above to download the question paper.<br><br>
- Open the question paper in Adobe Reader, or in a similar app, and set the zoom at 100%.<br>Zoom out only if it's necessary (i.e. if some questions do not fit in the screen).<br><br>
- Use Lighshot, or a similar app, to take screenshots.<br><br>
- All your screenshots should have (roughly) the same width.<br>In particular, they should always capture the entire paper width.<br><br>
- Leave a small space between the question and the borders or your screenshots.<br><br>
- The question number should not appear in the screenshot.<br>If there is no way around it, just erase it afterwards.<br><br>
- The name of each file must be equal to the question number (e.g. 1, 2, ... 14, 15, ... 39, 40).<br><br>
- The screenshots must have a .png or .PNG extension.<br><br>
- The file size should be as small as possible (ideally less than 30Ko each).<br>You can use the app TinyPNG to compress the files.
<p><input type="button" style="width: 15%;" value="NEXT" onclick="document.location.href='add_paper_upload.php?paper_reference=<?php echo $paper_reference; ?>';"></p>
<p>&nbsp;</p>
</body>
</html>