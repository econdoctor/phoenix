...
<b style="color: #820000;"><p>You can only upload 20 files at the time.</p>
<p>Let's start by uploading questions 1 to 20.</p></b>
<form action='add_paper_upload_go.php?paper_reference=<?php echo $paper_reference; ?>' method='post' enctype="multipart/form-data">
