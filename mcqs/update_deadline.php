...
exit();}
$sql_as = "SELECT assign_type, assign_name, assign_deadline, assign_teacher FROM phoenix_assign WHERE assign_id = '".$assign_id."'";
...
if($_GET['error'] == 2){
echo '<p><b style="color: #820000;">The new deadline has already passed</b></p>';}
?>
<form method="post" action="update_deadline_db.php?assign_id=<?php echo $assign_id; ?>">
<?php
if(strpos($_SERVER['HTTP_USER_AGENT'], 'Chrome') !== FALSE){
?>
<p><input name="new_deadline" type="text" placeholder="New Deadline" onfocus="(this.type='datetime-local')" required></p>
<?php
}
elseif(strpos($_SERVER['HTTP_USER_AGENT'], 'Firefox') !== FALSE){
?>
<p><table width="42%" align="center"><tbody><tr>
<td width="50%"><input name="new_deadline_date" type="text" style="width: 100%;" placeholder="New Deadline (Date)" onfocus="(this.type='date')" required></td>
<td width="1%"></td>
<td width="50%"><input name="new_deadline_time" type="text" style="width: 100%;" placeholder="New Deadline (Time)" onfocus="(this.type='time')" required></td>
</tr></tbody></table></p>
<?php
}
elseif(strpos($_SERVER['HTTP_USER_AGENT'], 'Safari') !== FALSE){
?>
<p><input name="new_deadline_date" type="text" placeholder="New deadline (Date: yyyy-mm-dd)" maxlength="10" required>&nbsp;&nbsp;
<input name="new_deadline_time" type="text" placeholder="New deadline (Time: hh:mm)" maxlength="5" required></p>
<?php
}
else {
?>
