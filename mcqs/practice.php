...
exit();}
$sql = "SELECT user_teacher, user_type, user_title, user_first_name, user_last_name, user_name FROM phoenix_users WHERE user_id ='".$user_id."'";
...
<p style="font-size: x-large"><b>PRACTICE</b></p>
<p><input type="button" value="IGCSE" onclick="document.location.href='practice_type.php?s=1';"/>&nbsp;&nbsp;
<input type="button" value="AS LEVEL" onclick="document.location.href='practice_type.php?s=2';"/>&nbsp;&nbsp;
<input type="button" value="A LEVEL" onclick="document.location.href='practice_type.php?s=3';"/></p>
</body></html>