...
if($_GET['error'] == 1){
?>
<p><b style="color: #820000">You must assign students to at least 2 distinct teams.</b></p>
<?php
}
?>
<form method="post" action="assign_copy_teams_go.php?copy_id=<?php echo $copy_id; ?>&assign_id=<?php echo $assign_id; ?>">
<p><b>How many teams do you want to make?</b>
<span class="brsmall"></span>
<select name="teams_number" style="width: 20%;">
<optgroup>
<?php
for($i=2; $i<=min(10,$nr_stu);$i++){
?>
...
<p><b>Do you want to randomly pre-assign students to the teams?</b></b>
<span class="brsmall"></span>
<input type="radio" style="transform: scale(1.5);" name="pre_assign" value='1' checked> Yes - <input type="radio" name="pre_assign" style="transform: scale(1.5);" value='2'> No</p>
