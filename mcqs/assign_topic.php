...
exit();}
$sqlcheck = "SELECT assign_teacher, assign_active, assign_name, assign_syllabus FROM phoenix_assign WHERE assign_id = '".$assign_id."'";
...
?>
<form name="form1" method="post" action="assign_topic.php?assign_id=<?php echo $assign_id; ?>">
...
<form method="post" action="assign_insertt.php?assign_id='.$assign_id.'">
...
$sql_count = "SELECT COUNT(*) FROM phoenix_questions WHERE question_topic_id = '".$data_get['topic_id']."' AND question_repeat = '0' AND question_obsolete = '0'";
