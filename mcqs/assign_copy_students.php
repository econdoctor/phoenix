...
$group_id = "Any";}
if($group_id == "Any"){
$sql2 = "SELECT user_id, user_first_name, user_last_name, user_title FROM phoenix_users WHERE user_teacher = '".$user_id."' AND user_syllabus = '".$s."'";}
if($group_id != "Any") {
$sql2 = "SELECT user_id, user_first_name, user_last_name, user_title FROM phoenix_users WHERE user_teacher = '".$user_id."' AND user_syllabus = '".$s."' AND user_id IN (SELECT user_id FROM phoenix_group_users WHERE group_id = '".$group_id."')";}
...
<form action="assign_copy_students.php?copy_id=<?php echo $copy_id; ?>&assign_id=<?php echo $assign_id; ?>" method="post">
<?php
if($nry > 0){
...
<p><form method="post" action="assign_copy_insert2.php?copy_id=<?php echo $copy_id; ?>&assign_id=<?php echo $assign_id; ?>">
...
<p><input type="submit" value="NEXT" onclick="preload();"></p>
</form>
