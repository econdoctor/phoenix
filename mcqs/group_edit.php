...
<form action="group_edit_db.php?group_id=<?php echo $group_id; ?>" method="post">
<p><input name="group_name" type="text" value="<?php echo $group_name; ?>" required></p>
<p><select name="group_curriculum" style="width: 20%" required><optgroup>
<option value="1" <?php echo is_selected($group_curriculum, "1"); ?>>IGCSE</option>
<option value="2" <?php echo is_selected($group_curriculum, "2"); ?>>AS Level</option>
<option value="3" <?php echo is_selected($group_curriculum, "3"); ?>>A2 Level</option>
</optgroup></select></p>
<p><input type="submit" value="EDIT"></p></form></body></html>