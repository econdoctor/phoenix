...
<p style="font-size: x-large"><b>EDIT A PAPER</b></p>
<p><b>Paper reference:</b><br>
<b style="color: #033909"><?php echo $paper_reference; ?></b></p>
<p><input type="button" value="THRESHOLDS" onclick="document.location.href='add_paper_gt.php?paper_reference=<?php echo $paper_reference; ?>';">&nbsp;
<input type="button" value="ANSWERS" onclick="document.location.href='add_paper_ms.php?paper_reference=<?php echo $paper_reference; ?>';">&nbsp;
<input type="button" value="QUESTIONS" onclick="document.location.href='add_paper_q.php?paper_reference=<?php echo $paper_reference; ?>';">&nbsp;
<input type="button" value="CLASSIFICATION" onclick="document.location.href='add_paper_classify.php?paper_reference=<?php echo $paper_reference; ?>';"></p>
<p>&nbsp;</p>
</body>
</html>