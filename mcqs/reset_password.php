...
<form action="reset_password_db.php?student_id=<?php echo $member_id; ?>" method="post">
<?php
if($_GET['error'] == 1){
...
?>
<p><input name="password_new" type="password" placeholder="New password" required></p>
<p><input name="password_new_confirm" type="password" placeholder="Confirm new password" required></p>
