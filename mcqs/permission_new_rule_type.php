...
<p>How do you want to select the questions to hide from your students?</p>
<input type="button" name="papers" value="PAPERS" onclick="document.location.href='permission_new_rule_paper.php?id=<?php echo $perm_id; ?>';"/>&nbsp;&nbsp;
<input type="button" name="topics" value="TOPICS" onclick="document.location.href='permission_new_rule_topic.php?id=<?php echo $perm_id; ?>';"/>
</p></body></html>