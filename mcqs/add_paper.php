...
<p style="font-size: x-large"><b>ADD OR EDIT A PAPER</b></p>
<form autocomplete="off" method="post" action="add_paper_insert1.php">
<p><input type="text" name="paper_reference" placeholder="Paper Reference" size="20" maxlength="14" required="required"><br>
<b style="font-size: medium; color: #820000;">Examples: 0455_s17_qp_22, 9708_w20_qp_13, etc.</b></p>
