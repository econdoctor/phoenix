...
exit();}
$sql_info = "SELECT assign_type, assign_name, assign_teacher, assign_time_allowed FROM phoenix_assign WHERE assign_id = '".$assign_id."'";
...
if($_GET['error'] == 2){
echo '<p><b style="color: #820000;">The time allowed must be positive</b></p>';}
if($_GET['error'] == 3){
echo '<p><b style="color: #820000;">The time allowed must be an integer</b></p>';}
?>
<form method="post" action="update_time_allowed_db.php?assign_id=<?php echo $assign_id; ?>">
<p><input type="text" name="new_time_allowed" size="6" maxlength="3" required placeholder="New time allowed (minutes)"><span class="brsmall"></span>
<b style="color: #820000;">Enter 0 for no time limit</b></p>
