...
<p style="font-size: x-large"><b>NEW RULE</b></p>
<p>Please select a course</p>
<input type="button" name="igcse" value="IGCSE" onclick="document.location.href='permission_new_rule_insert.php?s=1';"/>&nbsp;&nbsp;
<input type="button" name="as" value="AS LEVEL" onclick="document.location.href='permission_new_rule_insert.php?s=2';"/>&nbsp;&nbsp;
<input type="button" name="a2" value="A LEVEL" onclick="document.location.href='permission_new_rule_insert.php?s=3';"/>
</p></body></html>