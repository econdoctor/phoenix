...
<p style="font-size: x-large"><b><?php echo $s_text; ?> QUESTIONS</b></p><p>
<p><input type="button" name="papers" value="PAPERS" onclick="document.location.href='browse_paper.php?s=<?php echo $s; ?>';"/>&nbsp;
<input type="button" name="topics" value="TOPICS" onclick="document.location.href='browse_topic.php?s=<?php echo $s; ?>';"/></p>
<p>&nbsp;</p>
