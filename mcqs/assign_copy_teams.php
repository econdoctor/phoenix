...
<p><b>Do you want to make teams?</b></p>
<p><input type="button" value="YES" onclick="document.location.href='assign_copy_teams_set.php?copy_id=<?php echo $copy_id; ?>&assign_id=<?php echo $assign_id; ?>';">&nbsp;&nbsp;
<input type="button" value="NO" onclick="document.location.href='assign_copy_questions.php?copy_id=<?php echo $copy_id; ?>&assign_id=<?php echo $assign_id; ?>';"></p>
</body></html>