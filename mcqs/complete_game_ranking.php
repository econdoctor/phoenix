...
$num_c = $data_c['COUNT(*)'];
$completed = round($num_c / $assign_nq * 100, 0);
?>
<!doctype html>
<html>
<head>
...
$.ajax({
url: "ajax_ranking.php?assign_id=<?php echo $assign_id; ?>",
...
$own_team_rank = 1;
$previous = '';
$sql_team_rank = "SELECT team, score FROM phoenix_assign_teams WHERE assign_id = '".$assign_id."' ORDER BY score DESC";
