...
exit();}
$sqlcheck = "SELECT assign_teacher, assign_active, assign_name FROM phoenix_assign WHERE assign_id = '".$assign_id."'";
...
<p>How do you want to select the questions to assign to your students?</p>
<input type="button" name="papers" value="PAPERS" onclick="document.location.href='assign_paper.php?assign_id=<?php echo $assign_id; ?>';"/>&nbsp;&nbsp;
<input type="button" name="topics" value="TOPICS" onclick="document.location.href='assign_topic.php?assign_id=<?php echo $assign_id; ?>';"/>
</p></body></html>