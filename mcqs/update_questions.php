...
exit();}
$sqlcheck = "SELECT assign_deadline, assign_type, assign_teacher, assign_name, assign_pt FROM phoenix_assign WHERE assign_id = '".$assign_id."'";
...
echo 'You can no longer edit the questions of this assignment.';
exit();}
...
if($assign_pt == '1'){
?>
<input type="button" name="add" style="width: 20%" value="ADD QUESTIONS" onclick="document.location.href='assign_add_questions_paper.php?assign_id=<?php echo $assign_id; ?>';"/>&nbsp;&nbsp;
<?php
}
if($assign_pt == '2'){
?>
<input type="button" name="add" style="width: 20%" value="ADD QUESTIONS" onclick="document.location.href='assign_add_questions_topic.php?assign_id=<?php echo $assign_id; ?>';"/>&nbsp;&nbsp;
<?php
}
?>
<input type="button" name="remove" style="width: 20%" value="REMOVE QUESTIONS" onclick="document.location.href='assign_remove_questions.php?assign_id=<?php echo $assign_id; ?>';"/></p></div>
</body></html>