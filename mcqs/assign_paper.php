...
exit();}
$sqlcheck = "SELECT assign_teacher, assign_active, assign_syllabus, assign_name FROM phoenix_assign WHERE assign_id = '".$assign_id."'";
...
<form name="form1" method="post" action="assign_paper.php?assign_id=<?php echo $assign_id; ?>"><p>
...
if($nr2 > 0){
?>
<p><b><span style="color: #820000"><?php echo $nr2; ?></span> paper(s) found</b></p>
<form method="post" action="assign_insertp.php?assign_id=<?php echo $assign_id; ?>">
