...
<p style="font-size: x-large"><b>BROWSE</b></p><p>
<p><input type="button" name="igcse" value="IGCSE" onclick="document.location.href='browse_type.php?s=1';"/>&nbsp;
<input type="button" name="igcse" value="AS LEVEL" onclick="document.location.href='browse_type.php?s=2';"/>&nbsp;
<input type="button" name="igcse" value="A LEVEL" onclick="document.location.href='browse_type.php?s=3';"/></p>
</body>
</html>
