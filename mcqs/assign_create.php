...
exit();}
$sqlcheck = "SELECT assign_teacher, assign_active, assign_type, assign_pt, assign_start, assign_deadline, assign_syllabus FROM phoenix_assign WHERE assign_id = '".$assign_id."'";
...
header("Location: assign_options.php?assign_id=$assign_id&error=1&scramble=$scramble&hide=$hide&release=$release&min_a=$min_a&min_b=$min_b&min_c=$min_c&min_d=$min_d&min_e=$min_e&min_f=$min_f&min_g=$min_g&order=$order");
exit();}
$order_db = $mysqli -> real_escape_string($order);
$sql_up = "UPDATE phoenix_assign SET assign_start = '".$now."', assign_deadline = '".$now."', assign_created = '".$now."', assign_active = '1', assign_order = '".$order."', assign_scramble = '2' WHERE assign_id = '".$assign_id."'";
...
header("Location: assign_options.php?assign_id=$assign_id&error=1&show_ranking=$show_ranking&min_a=$min_a&min_b=$min_b&min_c=$min_c&min_d=$min_d&min_e=$min_e&min_f=$min_f&min_g=$min_g&order=$order&time_limit=$time_limit");
exit();}}
...
header("Location: assign_options.php?assign_id=$assign_id&error=2&show_ranking=$show_ranking&min_a=$min_a&min_b=$min_b&min_c=$min_c&min_d=$min_d&min_e=$min_e&min_f=$min_f&min_g=$min_g&order=$order&time_limit=$time_limit");
exit();}
...
if($s != '1' && ($min_a < $min_b || $min_b < $min_c || $min_c < $min_d || $min_d < $min_e)){
header("Location: assign_options.php?assign_id=$assign_id&error=2&scramble=$scramble&hide=$hide&release=$release&min_a=$min_a&min_b=$min_b&min_c=$min_c&min_d=$min_d&min_e=$min_e&min_f=$min_f&min_g=$min_g&order=$order");
exit();}
if($s == '1' && ($min_a < $min_b || $min_b < $min_c || $min_c < $min_d || $min_d < $min_e || $min_e < $min_f || $min_f < $min_g)){
header("Location: assign_options.php?assign_id=$assign_id&error=2&scramble=$scramble&hide=$hide&release=$release&min_a=$min_a&min_b=$min_b&min_c=$min_c&min_d=$min_d&min_e=$min_e&min_f=$min_f&min_g=$min_g&order=$order");
exit();}
