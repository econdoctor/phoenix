...
if(empty($member_id)){
echo 'Missing information about the student.';
exit();}
...
<form action="update_name_db.php?student_id=<?php echo $member_id; ?>" method="post">
<?php
if($_GET['error'] == 1){
echo '<p><b style="color: #820000;">Missing information</b></p>';}
?>
<p><select name="user_title" required><optgroup>
<option value="" disabled selected>Title</option>
<option value="Ms.">Ms.</option>
<option value="Mr.">Mr.</option>
</optgroup></select>&nbsp;&nbsp;
<input type="text" name="user_first_name" required placeholder="First Name" maxlength="32">&nbsp;&nbsp;
<input type="text" name="user_last_name" required placeholder="Last Name" maxlength="32"></p>
