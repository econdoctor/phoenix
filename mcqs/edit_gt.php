...
<p style="font-size: x-large"><b><?php echo $s_text; ?> GRADE THRESHOLDS</b></p>
<form method="post" action="edit_gt_db.php?s=<?php echo $s; ?>">
<p><table align="center" bgcolor="#000000" width="50%"><tbody><tr>
...
<td height="40" bgcolor="#769467"><input style="text-align: center" type="text" name="min_a" maxlength="2" required value="<?php echo $data_get['min_a']; ?>"></td>
<td height="40" bgcolor="#769467"><input style="text-align: center" type="text" name="min_b" maxlength="2" required value="<?php echo $data_get['min_b']; ?>"></td>
<td height="40" bgcolor="#769467"><input style="text-align: center" type="text" name="min_c" maxlength="2" required value="<?php echo $data_get['min_c']; ?>"></td>
<td height="40" bgcolor="#769467"><input style="text-align: center" type="text" name="min_d" maxlength="2" required value="<?php echo $data_get['min_d']; ?>"></td>
<td height="40" bgcolor="#769467"><input style="text-align: center" type="text" name="min_e" maxlength="2" required value="<?php echo $data_get['min_e']; ?>"></td>
<?php
if($s == '1'){
echo '<td height="40" bgcolor="#769467"><input style="text-align: center" type="text" name="min_f" maxlength="2" required value="'.$data_get['min_f'].'"></td>
<td height="40" bgcolor="#769467"><input style="text-align: center" type="text" name="min_g" maxlength="2" required value="'.$data_get['min_g'].'"></td>';}
?>
</tr></tbody></table></p>
