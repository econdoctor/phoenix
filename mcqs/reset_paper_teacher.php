...
$s = $_GET['s'];
if(empty($member_id) || empty($s) || empty($paper_id)){
...
exit();}
$sql_del = "DELETE FROM phoenix_answers WHERE user_id = '".$member_id."' AND answer_type = '1' AND paper_id = '".$paper_id."'";
$res_del = $mysqli -> query($sql_del);
$sql_up = "UPDATE phoenix_questions SET question_refresh = '1' WHERE question_paper_id = '".$paper_id."'";
