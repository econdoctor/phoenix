...
$answer = $_GET['answer'];
$sql_del = "DELETE FROM phoenix_answers WHERE user_id = '".$user_id."' AND question_id = '".$question_id."' AND answer_type = '1' AND paper_id = '".$paper_id."'";
...
if($answer != $correct_answer){
$valid = '0';}
$sql_insert = "INSERT INTO phoenix_answers (user_id, question_id, answer, answer_type, paper_id, answer_date, answer_valid, answer_syllabus) VALUES ('".$user_id."', '".$question_id."', '".$answer."', '1', '".$paper_id."', '".$answer_date."', '".$valid."', '".$s."')";
