...
exit();}
$division_g  = $_GET['s'];
$division_p  = $_POST['division'];
if(empty($division_p) && !empty($division_g)){
$division = $division_g;}
if(!empty($division_p) && empty($division_g)){
$division = $division_p;}
if(empty($division_p) && empty($division_g)){
...
<p style="font-size: x-large"><b>RANKING</b></p><p>
<form method="post" action="view_ranking.php">
<p><select name="division" onchange="this.form.submit();"><optgroup>
...
$student_fn = $data_get['user_first_name'];
$student_ln = $data_get['user_last_name'];
$student_t = $data_get['user_title'];
if($student_alias == ''){
...
<td height="40" bgcolor="#ffc000"><b>'.$student_t.' '.$student_fn.' '.$student_ln.'</b></td>
