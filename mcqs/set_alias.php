...
<p>In order to access the ranking, you must choose an <b>alias</b>.</p>
<p>Your alias will be displayed in the ranking instead of your real name.</p>
<form method="post" action="set_alias_db.php?s=<?php echo $s; ?>">
<?php
if($_GET['error'] == 1){
echo '<p><b style="color: #820000;">Please choose an alias.</b></p>';}
if($_GET['error'] == 2){
echo '<p><b style="color: #820000;">The alias '.$_GET['alias'].' is already used.<br>Please choose another one.</b></p>';}
?>
<p><input type="text" name="alias" placeholder="Your alias" size="12" maxlength="32" required></p>
