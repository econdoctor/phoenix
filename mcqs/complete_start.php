...
exit();}
$sql_check = "SELECT * FROM phoenix_assign_users WHERE assign_id = '".$assign_id."' AND student_id = '".$user_id."'";
...
exit();}
$sql_check2 = "SELECT assign_student_start FROM phoenix_assign_users WHERE student_id = '".$user_id."' AND assign_id = '".$assign_id."'";
$res_check2 = $mysqli -> query($sql_check2);
$data_check2 = mysqli_fetch_assoc($res_check2);
if($data_check2['assign_student_start'] != NULL){
header("Location: complete_go.php?assign_id=$assign_id");
exit();}
if($assign_time_allowed == 0 && $data_check2['assign_student_start'] == NULL){
$sql_s = "UPDATE phoenix_assign_users SET assign_student_start = '".$now."' WHERE student_id = '".$user_id."' AND assign_id = '".$assign_id."'";
...
<p><b>You are about to start the assignment.</b></p>
<p><b>You will have <span style="color: #820000"><?php echo $assign_time_allowed; ?></span> minutes to complete it.</b></p>
<p><b style="color: #820000">Once you click on the "START" button below, you will not be able to back out.</b></p>
<p><b style="color: #820000">Make sure you have sufficient time ahead of you.</b></p>
<p><b>Are you ready?</b></p>
<p><input type="button" name="start" value="START" onclick="document.location.href='complete_start_db.php?assign_id=<?php echo $assign_id; ?>';"/>&nbsp;&nbsp;</p>
</body></html>