...
<p style="font-size: x-large"><b>NEW GROUP</b></p>
<form action="group_create_db.php" method="post">
<p><input name="group_name" type="text" placeholder="Name" maxlength="64" required></p>
<p><select name="group_curriculum" style="width: 20%;" required><optgroup>
