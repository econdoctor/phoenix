...
exit();}
$sqlcheck = "SELECT assign_teacher, assign_pt, assign_name, assign_syllabus, assign_active FROM phoenix_assign WHERE assign_id = '".$assign_id."'";
...
if($assign_pt == "1"){
if($order == "original"){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id LEFT JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND question_paper_id IN (SELECT paper_id FROM phoenix_assign_qp WHERE assign_id = '".$assign_id."') AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_assign_questions_originality.originality ASC";}
if($order == '2'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_paper_id IN (SELECT paper_id FROM phoenix_assign_qp WHERE assign_id = '".$assign_id."') AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_questions.question_unit ASC, phoenix_questions.question_module ASC, phoenix_questions.question_number ASC, phoenix_questions.question_serie DESC";}
if($order == '3'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_paper_id IN (SELECT paper_id FROM phoenix_assign_qp WHERE assign_id = '".$assign_id."') AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_questions.question_serie DESC";}
if($order == '4'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_paper_id IN (SELECT paper_id FROM phoenix_assign_qp WHERE assign_id = '".$assign_id."') AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_questions.question_serie ASC";}
if($order == '6'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_paper_id IN (SELECT paper_id FROM phoenix_assign_qp WHERE assign_id = '".$assign_id."') AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY -phoenix_questions.question_rate DESC";}
if($order == '5'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_paper_id IN (SELECT paper_id FROM phoenix_assign_qp WHERE assign_id = '".$assign_id."') AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_questions.question_rate DESC";}
if($order == '7'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_paper_id IN (SELECT paper_id FROM phoenix_assign_qp WHERE assign_id = '".$assign_id."') AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_questions.question_random";}
if($order == "paper"){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_paper_id IN (SELECT paper_id FROM phoenix_assign_qp WHERE assign_id = '".$assign_id."') AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_questions.question_serie DESC, phoenix_questions.question_paper_id DESC, phoenix_questions.question_number ASC";}}
if($assign_pt == "2"){
if($order == "original"){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id LEFT JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_topic_id IN (SELECT topic_id FROM phoenix_assign_t WHERE assign_id = '".$assign_id."') AND phoenix_questions.question_repeat = '0' AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_assign_questions_originality.originality ASC";}
if($order == '2'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_topic_id IN (SELECT topic_id FROM phoenix_assign_t WHERE assign_id = '".$assign_id."') AND phoenix_questions.question_repeat = '0' AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_questions.question_unit ASC, phoenix_questions.question_module ASC, phoenix_questions.question_number ASC, phoenix_questions.question_serie DESC";}
if($order == '7'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_topic_id IN (SELECT topic_id FROM phoenix_assign_t WHERE assign_id = '".$assign_id."') AND phoenix_questions.question_repeat = '0' AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_questions.question_random";}
if($order == '3'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_topic_id IN (SELECT topic_id FROM phoenix_assign_t WHERE assign_id = '".$assign_id."') AND phoenix_questions.question_repeat = '0' AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_questions.question_serie DESC";}
if($order == '4'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_topic_id IN (SELECT topic_id FROM phoenix_assign_t WHERE assign_id = '".$assign_id."') AND phoenix_questions.question_repeat = '0' AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_questions.question_serie ASC";}
if($order == '5'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_topic_id IN (SELECT topic_id FROM phoenix_assign_t WHERE assign_id = '".$assign_id."') AND phoenix_questions.question_repeat = '0' AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY phoenix_questions.question_rate DESC";}
if($order == '6'){
$sql_main = "SELECT * FROM phoenix_questions INNER JOIN phoenix_topics ON phoenix_questions.question_topic_id = phoenix_topics.topic_id INNER JOIN phoenix_assign_questions_originality ON phoenix_questions.question_id = phoenix_assign_questions_originality.question_id WHERE phoenix_questions.question_topic_id IN (SELECT topic_id FROM phoenix_assign_t WHERE assign_id = '".$assign_id."') AND phoenix_questions.question_repeat = '0' AND phoenix_assign_questions_originality.originality = (CASE WHEN '".$never."' = '1' THEN '0' ELSE phoenix_assign_questions_originality.originality END) AND phoenix_assign_questions_originality.teacher_id = '".$user_id."' AND phoenix_questions.question_answer <> '0' ORDER BY -phoenix_questions.question_rate DESC";}}
...
<form method="post" action="assign_questions.php?assign_id=<?php echo $assign_id; ?>">
...
<p>Please select the questions you want to include in the assignment.</p>
...
<div id="y"></div>
<form method="post" action="assign_insertq.php?assign_id=<?php echo $assign_id; ?>">
<?php
if($count == 0){
