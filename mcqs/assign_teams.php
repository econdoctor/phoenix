...
<p><input type="button" value="YES" onclick="document.location.href='assign_teams_set.php?assign_id=<?php echo $assign_id; ?>';">&nbsp;&nbsp;
<input type="button" value="NO" onclick="document.location.href='assign_type.php?assign_id=<?php echo $assign_id; ?>';"></p>
</body></html>